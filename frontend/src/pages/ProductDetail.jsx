        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8">
          ...
          <div className="lg:col-span-5">
            <div className="lg:sticky lg:top-24">
              ...
              {/* Tablet Buy Buttons */}
              <div className="hidden md:flex lg:hidden fixed bottom-0 left-0 right-0 bg-card border-t border-border p-4 z-40">
                <div className="flex gap-3 max-w-2xl mx-auto w-full">
                  <button onClick={handleAddToCart} className="flex-1 basis-0 py-3 border-2 border-accent text-accent font-medium rounded-lg flex items-center justify-center gap-2 hover:bg-accent/5 transition-colors">
                    <ShoppingCart className="w-5 h-5"/>
                    Add to Cart
                  </button>
                  <button onClick={handleBuyNow} className="flex-1 basis-0 py-3 bg-accent text-accent-foreground font-medium rounded-lg hover:opacity-90 transition-colors">
                    Buy Now
                  </button>
                </div>
              </div>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="bg-card rounded-lg border border-border p-4 mb-4">
              ...
              <div className="flex md:hidden gap-3 mt-4">
                ...
                <button onClick={handleBuyNow} className="flex-1 py-3 bg-accent text-accent-foreground font-medium rounded-lg hover:opacity-90 transition-colors">
                  Buy Now
                </button>
              </div>
            </div>
