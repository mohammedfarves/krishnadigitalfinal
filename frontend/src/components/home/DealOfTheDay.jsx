...
export function DealOfTheDay() {
    ...
    return (<section className="py-8 md:py-12 relative overflow-hidden">
      ...
      <div className="container relative">
        ...
        {/* Mobile view all */}
        <Link to="/products?deals=true" className="sm:hidden flex items-center justify-center gap-1 text-sm font-medium text-accent mt-6 py-3 border-t border-border">
          View all deals <ArrowRight className="w-4 h-4"/>
        </Link>
      </div>
    </section>);
